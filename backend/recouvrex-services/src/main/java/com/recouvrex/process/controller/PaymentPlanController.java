...
public class PaymentPlanController {
    ...
    // Dans PaymentPlanController, ajoutez :
    ...
    public ResponseEntity<List<PaymentPlanResponseDTO>> getPaymentPlans(
        ...
        try {
            ...
            if (caseId != null) {
                ...
                // Filtrer par responsable (plans en attente de validation)
                plans = paymentPlanService.getPendingPaymentPlans(managerId);
            } else {
                // TODO: Retourner tous les plans (à implémenter dans le service)
    ...
    /**
     * Envoyer les rappels d'échéances (tâche programmée ou manuelle)
     */
