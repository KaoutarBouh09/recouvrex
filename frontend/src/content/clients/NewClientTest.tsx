...
export default function NewClientTest({ setIsNewFactOpen ,setAjouterClicked}) {
  //use context
  ...
  return (
    ...
    />
        ...
        {successMessage && (
         ...
         <Grid item xs={6} display={"flex"} justifyContent={"end"} spacing={1}>
