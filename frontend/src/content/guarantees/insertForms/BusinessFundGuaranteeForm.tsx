...
export default function BusinessFundGuaranteeForm({ open, setOpen }) {
  const { createNewGuarantee, creditId } = useGuaranteeContext();

  // Object to hold form values
  const initialFormValues: BusinessFundGuarantee = {
    id: 0,
    credit: { id: parseInt(creditId) }, // Assuming this is the credit ID
    ownerFullName: "Jane Doe",
    corporateName: "ABC Inc.",
    socialCapital: 1000000,
    commerceRegistryNumber: "123-456-789",
    commerceRegistryCity: "New York",
    managerFullName: "John Smith",
    managerNationalIDCard: "A123456789",
    tradeName: "ABC Trade",
    pledgeRank: "First Rank",
    pledgeRealizationDate: new Date("2022-05-01"),
    pledgeExpirationDate: new Date("2022-05-01"),
  ...
  const [formValues, setFormValues] =
    React.useState<BusinessFundGuarantee>(initialFormValues);
  ...
  function handleCreateNewBusinessFundGuarantee() {
    createNewGuarantee(formValues, "business_fund");
    handleClose();
  }
      ...
      >
        <DialogTitle sx={{ m: 0, p: 2 }} id="customized-dialog-title">
          <Typography variant="h3">
            Nouvelle Garantie Fonds de Commerce
          </Typography>
        </DialogTitle>
        <IconButton
          aria-label="close"
        ...
        <DialogActions>
          <Button
            ...
            type="submit"
            onClick={() => {
              handleCreateNewBusinessFundGuarantee();
            }}
          >
            Enregistrer
          </Button>
