...
import RembourseDialog from "./rembourssement/RembourseDialog";

// interface CaseHeaderProps {
//   caseId: string;
// }

function CaseHeader({setIsDueDateStatusChange,isDueDateStatusChange,setRefrechAgreements}) {
      ...
      <Grid item>
        ...
        >
          <Typography variant="h3" sx={{ mt: 1, ml: 1 }}>
            Recouvrements #{selectedCase?.caseId}
          </Typography>
          <Button
            size="small"
        ...
        >
          ...
          <RembourseDialog  setRefrechAgreements={setRefrechAgreements}  setIsDueDateStatusChange={setIsDueDateStatusChange}/>
