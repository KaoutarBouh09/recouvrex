...
function CaseNonPaidInvoices({setIsDueDateStatusChange,isDueDateStatusChange}) {
  ...
  return (
    <Card>
      ...
      <Box>
        <InvoicesTable  setIsDueDateStatusChange={setIsDueDateStatusChange} isDueDateStatusChange={isDueDateStatusChange}/>
      </Box>
    </Card>
  );
}
