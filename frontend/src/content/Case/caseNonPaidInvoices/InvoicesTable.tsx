...
export default function InvoicesTable({setIsDueDateStatusChange,isDueDateStatusChange}) {
  ...
  useEffect(() => {
    getDueDatesInfo(id);
    setIsDueDateStatusChange(false)
  }, [id, isNewFactOpen ,isDueDateStatusChange]);
          ...
          {dueDates.map((dueDate) => (
            ...
            >
              ...
              <TableCell component="th" scope="row">
                <Link to={`/invoice/${dueDate.dueDateId}`} rel="noopener noreferrer">
                  {dueDate.dueDateId}
                </Link>
