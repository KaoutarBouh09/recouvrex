...
import Achievement from "src/content/tasks/Achievement";
...
function EnhancedTableToolbar(props: EnhancedTableToolbarProps) {
  const { numSelected, handleDeleteTasks } = props;
  ...
  return (
    ...
    >
      ...
      {numSelected > 0 ? (
        ...
        //   </IconButton>
        // </Tooltip>
        <AlertDialog setConfirmDelete={setConfirmDelete} />
      ) : (
        <>
...
export default function TasksTable({
  ...
  const formatTime = (inputTime: string | Date) => {
    // Create a new Date object from the inputTime string
