...
export default function CaseTasks() {
  ...
  const [fetchTasks, setfetchTasks] = React.useState(false)
  return (
    <>
      <Accordion>
        <AccordionSummary
        ...
        <AccordionDetails>
          ...
          >
            ...
            <Tooltip arrow title="Rafraîchir">
              <IconButton size="large" onClick={()=>{setfetchTasks(true)}}>
            ...
            <Tooltip arrow title="List des tâches">
              <IconButton 
               ...
               to={`/tasks/${selectedCase?.caseId}`}  
              size="large">
                <FormatListBulletedIcon fontSize="small" />
              </IconButton>
            </Tooltip>
          </Box>
          <TasksTable fetchTasks={fetchTasks} setfetchTasks={setfetchTasks}/>
        </AccordionDetails>
      </Accordion>
    </>
  );
