...
function Guarantees() {
 ...
 // const { creditId = "" } = useParams();
  ...
  useEffect(() => {
    setCreditId((creditData.id).toString());
  }, [creditData, setCreditId]);
    ...
    <>
      <Accordion>
          <AccordionSummary
            ...
            id="panel1-header"
          >
            <Typography variant="h3">Garanties</Typography>
          </AccordionSummary>
          <AccordionDetails>
          <Grid item sm={12}>
      ...
      (  guarantees?.vehicleGuarantees.length==0 ) && 
          <Grid item xs={12}>
              ...
              Aucune garantie n'est disponible pour le crédit n°{creditData.creditId}
              </Typography>
              </Stack>
            </Grid>}
            <Grid item xs={12}>
